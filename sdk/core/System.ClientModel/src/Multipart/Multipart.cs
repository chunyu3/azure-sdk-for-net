...
#pragma warning restore AZC0012 // Avoid single word type names
{
    ...
    public Multipart(string subtype, string boundary) : this(subtype, boundary, new List<MultipartContent>())
    {
    }
    ...
    internal Multipart(string subtype, string boundary, IReadOnlyList<MultipartContent> nestedContent)
    {
    ...
    /// </summary>
    private static async Task<IReadOnlyList<MultipartContent>> ReadAsync(BinaryData data, string contentType)
    {
        if (data == null)
        {
    ...
    private protected static IReadOnlyList<MultipartContent> Read(BinaryData data, string contentType)
    {
        if (data == null)
        {
            throw new ArgumentNullException(nameof(data));
