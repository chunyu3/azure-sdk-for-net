...
namespace System.ClientModel.Primitives
{
    ...
    /// </summary>
    public abstract class MultipartBinaryContent : BinaryContent, IDisposable
    {
        ...
        public MultipartBinaryContent(string subtype, string boundary) : this(subtype, boundary, new List<MultipartContent>())
        {
        }
        ...
        internal MultipartBinaryContent(string subtype, string boundary, IReadOnlyList<MultipartContent> nestedContent)
        {
