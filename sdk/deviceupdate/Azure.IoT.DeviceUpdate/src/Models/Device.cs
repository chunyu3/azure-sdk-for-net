...
namespace Azure.IoT.DeviceUpdate.Models
{
    ...
    public partial class Device
    {
        ...
        internal Device(string deviceId, string moduleId, string deviceClassId, string manufacturer, string model, string groupId, UpdateId lastAttemptedUpdateId, DeviceDeploymentState? deploymentStatus, UpdateId installedUpdateId, bool onLatestUpdate, string lastDeploymentId, InstallResult lastInstallResult)
        {
            DeviceId = deviceId;
            ModuleId = moduleId;
            DeviceClassId = deviceClassId;
