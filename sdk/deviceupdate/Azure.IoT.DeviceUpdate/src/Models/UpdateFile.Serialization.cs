    ...
    public partial class UpdateFile
    {
        internal static UpdateFile DeserializeUpdateFile(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("scanDetails"))
                {
            ...
            return new UpdateFile(fileId, fileName, sizeInBytes, hashes, mimeType.Value, scanResult.Value, scanDetails.Value, etag.Value);
        }
    }
}
