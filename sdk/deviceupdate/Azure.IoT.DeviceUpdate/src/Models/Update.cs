...
namespace Azure.IoT.DeviceUpdate.Models
{
    ...
    public partial class Update
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="updateId"/>, <paramref name="compatibility"/> or <paramref name="manifestVersion"/> is null. </exception>
        internal Update(UpdateId updateId, IEnumerable<IDictionary<string, string>> compatibility, string manifestVersion, DateTimeOffset importedDateTime, DateTimeOffset createdDateTime)
        {
            if (updateId == null)
            {
        ...
        /// <summary> String interpreted by Device Update client to determine if the update is installed on the device. Deprecated in latest import manifest schema. </summary>
