...
namespace Azure.IoT.DeviceUpdate.Models
{
    public partial class UpdateOperation
    {
        internal static UpdateOperation DeserializeUpdateOperation(JsonElement element)
        {
            ...
            return new UpdateOperation(operationId, status, updateId.Value, resourceLocation.Value, error.Value, traceId.Value, lastActionDateTime, createdDateTime, etag.Value);
        }
    }
}
