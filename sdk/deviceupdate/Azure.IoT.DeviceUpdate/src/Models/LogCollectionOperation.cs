...
namespace Azure.IoT.DeviceUpdate.Models
{
    ...
    public partial class LogCollectionOperation
    {
        ...
        public LogCollectionOperation(IEnumerable<DeviceUpdateAgentId> deviceList)
        {
            if (deviceList == null)
            {
        ...
        internal LogCollectionOperation(string operationId, IList<DeviceUpdateAgentId> deviceList, string description, string createdDateTime, string lastActionDateTime, OperationStatus? status)
        {
        ...
        /// <summary> The diagnostics operation id. </summary>
